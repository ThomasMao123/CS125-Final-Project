...
public final class MainActivity extends AppCompatActivity {
    ...
    /** MTD_API_Key*/
    private final String MTD_API_Key = "86639260e8744e749c5fd72630c543d5";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
         ...
         */
        final Button getNews = findViewById(R.id.startAPICall);
    ...
    void startAPICall() {
        try {
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                    Request.Method.GET,
                    "https://developer.cumtd.com/api/v2.2/json/getstop?key=86639260e8744e749c5fd72630c543d5",
                    null,
